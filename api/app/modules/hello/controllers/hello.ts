...
export class HelloController extends BaseController {
    ...
    helloWithtName(req, res) {
        res.json({
            ...
            if_you_feel_alone: "curl -H \"Content-Type: application/json\" -X POST -d '{\"name\": \"mark\" }' http://localhost:3000/friends",
            if_your_friend_has_inexplicably_changed_name: "curl -H \"Content-Type: application/json\" -X PUT -d '{\"name\": \"john\" }' http://localhost:3000/friends/mark",
